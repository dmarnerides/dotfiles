...
remap('', '<leader>ee', "<Esc>:NvimTreeToggle<CR>", { noremap = true, silent = true })
remap('', '<leader>ef', "<Esc>:NvimTreeFindFile<CR>", { noremap = true, silent = true })
remap('', '<C-n>', "<Esc>:NvimTreeToggle<CR>", { noremap = true, silent = true })
remap('', '<leader>r', "<Esc>:NvimTreeRefresh<CR>", { noremap = true, silent = true })
remap('', '<leader>n', "<Esc>:NvimTreeFindFile<CR>", { noremap = true, silent = true })
...
require 'nvim-tree'.setup {
  ...
  renderer = {
    ...
    icons                = {
      padding       = ' ',
      symlink_arrow = ' >> ',
      show          = { git = true, folder = false, file = false, folder_arrow = false },
      glyphs = {
        default       = '',
        symlink       = '',
        git           = {
