...
-- Set input mode cursor to be a vertical line with blinking
vim.o.guicursor = "i-ci-ve:ver80-blinkon200-blinkoff150"
...
vim.g.colorcolumn       = 80        -- mark column 80
...
vim.o.smartindent = false -- add <tab> depending on syntax (C/C++)
