" Adapted from https://github.com/ChristianChiarulli/nvcode-color-schemes.vim
...
let g:colors_name='my_nvcode'

" hi Normal guifg=#abb2bf ctermfg=249 guibg=#1e1e1e ctermbg=234 gui=NONE cterm=NONE
hi Normal guifg=#abb2bf ctermfg=249 guibg=#181818 ctermbg=234 gui=NONE cterm=NONE
hi NormalNC ctermbg=NONE guibg=#282828 cterm=NONE gui=NONE
...
hi Error guifg=#d16969 ctermfg=203 guibg=#181818 ctermbg=NONE gui=bold cterm=bold
" hi Error guifg=#d16969 ctermfg=203 guibg=NONE ctermbg=NONE gui=bold,reverse cterm=bold,reverse
hi Todo guifg=#BBBBBB ctermfg=175 guibg=#608b4e ctermbg=NONE gui=bold,italic cterm=bold,italic
...
hi CursorLineNr guifg=#abb2bf ctermfg=249 guibg=#181818 ctermbg=NONE gui=bold cterm=bold
" hi SignColumn guifg=NONE ctermfg=NONE guibg=#282828 ctermbg=234 gui=NONE cterm=NONE
...
hi DiffAdd guifg=#181818 ctermfg=234 guibg=#608b4e ctermbg=65 gui=NONE cterm=NONE
...
hi DiffDelete guifg=#d16969 ctermfg=234 guibg=#181818 ctermbg=167 gui=NONE cterm=NONE
" hi DiffText guifg=#1e1e1e ctermfg=234 guibg=#dcdcaa ctermbg=187 gui=NONE cterm=NONE
hi DiffText guifg=#181818 ctermfg=234 guibg=#dcdcaa ctermbg=187 gui=NONE cterm=NONE
hi ErrorMsg guifg=#d16969 ctermfg=203 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
hi VertSplit guifg=#3e4452 ctermfg=238 guibg=#181818 ctermbg=NONE gui=NONE cterm=NONE
...
" hi IncSearch guifg=NONE ctermfg=NONE guibg=#181818 ctermbg=241 gui=reverse cterm=reverse
" hi LineNr guifg=#858585 ctermfg=102 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
hi LineNr guifg=#858585 ctermfg=102 guibg=#181818 ctermbg=NONE gui=NONE cterm=NONE
...
hi PmenuSel guifg=#181818 ctermfg=234 guibg=#569cd6 ctermbg=74 gui=NONE cterm=NONE
...
hi Search ctermfg=0 guifg=#d4d4d4 ctermbg=7 guibg=#5050d0 cterm=NONE gui=NONE
" hi Search ctermfg=0 guifg=#181818 ctermbg=7 guibg=#88ddff cterm=NONE gui=NONE
" hi Search guifg=NONE ctermfg=NONE guibg=#181818 ctermbg=241 gui=reverse cterm=reverse
hi SpecialKey guifg=#3b4048 ctermfg=238 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
hi SpellBad guifg=#d16969 ctermfg=203 guibg=NONE ctermbg=NONE gui=underline cterm=underline
...
hi StatusLine guifg=#abb2bf ctermfg=249 guibg=#282828 ctermbg=236 gui=NONE cterm=NONE
hi StatusLineNC guifg=#abb2bf ctermfg=241 guibg=#181818 ctermbg=NONE gui=NONE cterm=NONE
...
hi StatusLineTermNC guifg=#abb2bf ctermfg=249 guibg=#181818 ctermbg=236 gui=NONE cterm=NONE
...
hi Terminal guifg=#abb2bf ctermfg=249 guibg=#181818 ctermbg=234 gui=NONE cterm=NONE
" hi Visual guifg=NONE ctermfg=NONE guibg=#8840CC ctermbg=238 gui=reverse cterm=reverse
" hi Visual guifg=NONE ctermfg=NONE guibg=#000000 ctermbg=238 gui=reverse cterm=reverse
hi Visual guifg=NONE ctermfg=NONE guibg=#181818 ctermbg=238 gui=reverse cterm=reverse
...
hi WildMenu guifg=#181818 ctermfg=234 guibg=#569cd6 ctermbg=74 gui=NONE cterm=NONE
" hi EndOfBuffer guifg=#1e1e1e ctermfg=234 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
hi EndOfBuffer guifg=#282828 ctermfg=234 guibg=#282828 ctermbg=NONE gui=NONE cterm=NONE
hi TSComment guifg=#608b4e ctermfg=65 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
hi TSError guifg=#d16969 ctermfg=203 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
...
hi EasyMotionTarget guifg=#d16969 ctermfg=203 guibg=NONE ctermbg=NONE gui=bold cterm=bold
hi EasyMotionTarget2First guifg=#d16969 ctermfg=203 guibg=NONE ctermbg=NONE gui=bold cterm=bold
hi EasyMotionTarget2Second guifg=#d16969 ctermfg=203 guibg=NONE ctermbg=NONE gui=bold cterm=bold
...
hi GitSignsDelete guifg=#94151b ctermfg=88 guibg=#181818 ctermbg=NONE gui=NONE cterm=NONE
hi GitGutterDelete guifg=#94151b ctermfg=88 guibg=#181818 ctermbg=NONE gui=NONE cterm=NONE
hi CocGitDeleteSign guifg=#94151b ctermfg=88 guibg=#181818 ctermbg=NONE gui=NONE cterm=NONE
hi LspDiagnosticsUnderlineHint guifg=#729cb3 ctermfg=73 guibg=#181818 ctermbg=NONE gui=NONE cterm=NONE
hi LspDiagnosticsSignError guifg=#d16969 ctermfg=203 guibg=#181818 ctermbg=NONE gui=bold cterm=bold
hi CocErrorSign guifg=#d16969 ctermfg=203 guibg=#181818 ctermbg=NONE gui=bold cterm=bold
hi LspDiagnosticsSignWarning guifg=#ff8800 ctermfg=208 guibg=#181818 ctermbg=NONE gui=NONE cterm=NONE
hi CocWarningSign guifg=#ff8800 ctermfg=208 guibg=#181818 ctermbg=NONE gui=NONE cterm=NONE
hi LspDiagnosticsSignInformation guifg=#ffcc66 ctermfg=221 guibg=#181818 ctermbg=NONE gui=NONE cterm=NONE
hi CocInfoSign guifg=#ffcc66 ctermfg=221 guibg=#181818 ctermbg=NONE gui=NONE cterm=NONE
hi LspDiagnosticsSignHint guifg=#4fc1ff ctermfg=75 guibg=#181818 ctermbg=NONE gui=NONE cterm=NONE
hi CocHintSign guifg=#4fc1ff ctermfg=75 guibg=#181818 ctermbg=NONE gui=NONE cterm=NONE
hi LspDiagnosticsVirtualTextError guifg=#d16969 ctermfg=203 guibg=#181818 ctermbg=NONE gui=NONE cterm=NONE
hi LspDiagnosticsVirtualTextWarning guifg=#ff8800 ctermfg=208 guibg=#181818 ctermbg=NONE gui=NONE cterm=NONE
...
" hi BufferCurrent guifg=#abb2bf ctermfg=249 guibg=#181818 ctermbg=234 gui=NONE cterm=NONE
hi BufferCurrentIndex guifg=#569cd6 ctermfg=74 guibg=#1e1e1e ctermbg=234 gui=NONE cterm=NONE
" hi BufferCurrentIndex guifg=#569cd6 ctermfg=74 guibg=#181818 ctermbg=234 gui=NONE cterm=NONE
hi BufferCurrentMod guifg=#abb2bf ctermfg=249 guibg=#1e1e1e ctermbg=234 gui=NONE cterm=NONE
" hi BufferCurrentMod guifg=#abb2bf ctermfg=249 guibg=#181818 ctermbg=234 gui=NONE cterm=NONE
hi BufferCurrentSign guifg=#569cd6 ctermfg=74 guibg=#1e1e1e ctermbg=234 gui=NONE cterm=NONE
" hi BufferCurrentSign guifg=#569cd6 ctermfg=74 guibg=#181818 ctermbg=234 gui=NONE cterm=NONE
hi BufferCurrentTarget guifg=#d16969 ctermfg=167 guibg=#1e1e1e ctermbg=234 gui=bold cterm=bold
" hi BufferCurrentTarget guifg=#d16969 ctermfg=167 guibg=#181818 ctermbg=234 gui=bold cterm=bold
hi BufferVisible guifg=#abb2bf ctermfg=249 guibg=#1e1e1e ctermbg=234 gui=NONE cterm=NONE
" hi BufferVisible guifg=#abb2bf ctermfg=249 guibg=#181818 ctermbg=234 gui=NONE cterm=NONE
hi BufferVisibleIndex guifg=#abb2bf ctermfg=249 guibg=#1e1e1e ctermbg=234 gui=NONE cterm=NONE
" hi BufferVisibleIndex guifg=#abb2bf ctermfg=249 guibg=#181818 ctermbg=234 gui=NONE cterm=NONE
hi BufferVisibleMod guifg=#abb2bf ctermfg=249 guibg=#1e1e1e ctermbg=234 gui=NONE cterm=NONE
" hi BufferVisibleMod guifg=#abb2bf ctermfg=249 guibg=#181818 ctermbg=234 gui=NONE cterm=NONE
hi BufferVisibleSign guifg=#abb2bf ctermfg=249 guibg=#1e1e1e ctermbg=234 gui=NONE cterm=NONE
" hi BufferVisibleSign guifg=#abb2bf ctermfg=249 guibg=#181818 ctermbg=234 gui=NONE cterm=NONE
hi BufferVisibleTarget guifg=#d16969 ctermfg=167 guibg=#1e1e1e ctermbg=234 gui=bold cterm=bold
" hi BufferVisibleTarget guifg=#d16969 ctermfg=167 guibg=#181818 ctermbg=234 gui=bold cterm=bold
hi BufferInactive guifg=#858585 ctermfg=102 guibg=#282828 ctermbg=236 gui=NONE cterm=NONE
hi BufferInactiveIndex guifg=#858585 ctermfg=102 guibg=#282828 ctermbg=236 gui=NONE cterm=NONE
hi BufferInactiveMod guifg=#858585 ctermfg=102 guibg=#282828 ctermbg=236 gui=NONE cterm=NONE
hi BufferInactiveSign guifg=#858585 ctermfg=102 guibg=#282828 ctermbg=236 gui=NONE cterm=NONE
hi BufferInactiveTarget guifg=#d16969 ctermfg=167 guibg=#282828 ctermbg=236 gui=bold cterm=bold
